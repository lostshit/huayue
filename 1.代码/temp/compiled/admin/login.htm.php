...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  ...
  <tr>
    <td><img src="images/login.png" width="178" height="256" border="0" alt="allweb" /></td>
    <td style="padding-left: 50px">
      ...
      <tr>
        <td colspan="2" align="right">&raquo; <a href="../" style="color:#000"><?php echo $this->_var['lang']['back_home']; ?></a> &raquo; <a href="get_password.php?act=forget_pwd" style="color:#000"><?php echo $this->_var['lang']['forget_pwd']; ?></a></td>
      </tr>
      </table>
    </td>
  </tr>
