...
$_LANG['send_success_sms'] = '密码已经通过短信发到您的手机：';
...
$_LANG['shipping_not_need'] = '无需使用看房服务';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、看房服务、包装、贺卡、红包等）以第二个为准。';
$_LANG['subtotal'] = '小计';
