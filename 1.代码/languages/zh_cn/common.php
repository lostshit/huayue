...
$_LANG['sys_msg'] = '系统提示';
$_LANG['catalog'] = '目录';
$_LANG['please_view_order_detail'] = '房源已锁定，详情请到用户中心订单详情查看';
$_LANG['user_center'] = '用户中心';
$_LANG['shop_closed'] = '本平台房源更新中，请您稍后再来...';
$_LANG['shop_register_closed'] = '该网销平台暂停注册';
...
$_LANG['best_goods'] = '精品房源';
$_LANG['new_goods'] = '新房上市';
...
$_LANG['tag_cloud_desc'] = '标签云（Tag cloud）是用以表示一个网站中的内容标签。 标签（tag、关键词）是一种更为灵活、有趣的房源分类方式，您可以为每个房源添加一个或多个标签，那么可以通过点击这个标签查看房源其他会员提交的与您的标签一样的房源,能够让您使用最快的方式查找某一个标签的所有网销平台房源。比方说点击“红色”这个标签，就可以打开这样的一个页面，显示所有的以“红色” 为标签的网销平台房源';
...
$_LANG['drop_consignee_confirm'] = '您确定要删除该购房人信息吗？';
...
/* 虚拟房源 */
$_LANG['virtual_goods_ship_fail'] = '自动锁定失败，请尽快联系商家重新锁定';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.allweb.com.cn" target="_blank" style=" font-family:Verdana; font-size:11px;">';
$_LANG['p_y']['link_p'] = 'Powe';
$_LANG['p_y']['link_r'] = 'red&nbsp;';
$_LANG['p_y']['link_b'] = 'by&nbsp;';
$_LANG['p_y']['main_start'] = '<strong><span style="color: #3366FF">';
$_LANG['p_y']['main_e'] = '';
$_LANG['p_y']['main_c'] = 'ALLWEB';
$_LANG['p_y']['main_p'] = '.COM.CN</span>&nbsp;';
