...
$_LANG['ss'][SS_UNSHIPPED] = '未成交';
$_LANG['ss'][SS_PREPARING] = '配货中';
$_LANG['ss'][SS_SHIPPED] = '已成交';
$_LANG['ss'][SS_RECEIVED] = '收货联系';
$_LANG['ss'][SS_SHIPPED_PART] = '已成交(部分房源)';
$_LANG['ss'][SS_SHIPPED_ING] = '成交中';

$_LANG['ps'][PS_UNPAYED] = '未付款';
$_LANG['ps'][PS_PAYING] = '付款中';
$_LANG['ps'][PS_PAYED] = '已付款';

$_LANG['ss_admin'][SS_SHIPPED_ING] = '成交中（前台状态：未成交）';
/* 订单操作 */
$_LANG['label_operable_act'] = '当前可执行操作：';
$_LANG['label_action_note'] = '操作备注：';
$_LANG['label_invoice_note'] = '成交备注：';
$_LANG['label_invoice_no'] = '成交单号：';
...
$_LANG['print_shipping'] = '打印看房通知单';
$_LANG['print_order_sn'] = '订单编号：';
$_LANG['print_buy_name'] = '购 房 人：';
$_LANG['label_consignee_address'] = '产权人地址：';
$_LANG['no_print_shipping'] = '很抱歉,目前您还没有设置打印看房通知单模板.不能进行打印';
...
$_LANG['consignee_info'] = '产权人信息';
$_LANG['fee_info'] = '费用信息';
$_LANG['action_info'] = '操作信息';
$_LANG['shipping_info'] = '看房信息';
...
$_LANG['label_shipping_time'] = '成交时间：';
$_LANG['label_sign_building'] = '标志性建筑：';
$_LANG['label_best_time'] = '最佳看房时间：';
...
$_LANG['goods_attr'] = '属性';
$_LANG['goods_delivery'] = '已成交数量';
$_LANG['goods_delivery_curr'] = '此单成交数量';
$_LANG['storage'] = '库存';
$_LANG['subtotal'] = '小计';
...
$_LANG['shipping_status'] = '成交状态';
$_LANG['action_note'] = '备注';
$_LANG['pay_note'] = '支付备注：';

$_LANG['sms_time_format'] = 'm月j日G时';
$_LANG['order_shipped_sms'] = '您的订单%s已于%s成交 [%s]';
...
/* 购房人信息 */
$_LANG['display_buyer'] = '显示购房人信息';
$_LANG['buyer_info'] = '购房人信息';
...
$_LANG['os_not_unconfirmed_or_confirmed'] = '%s 的订单状态不是“未联系”或“已联系”';
$_LANG['ps_not_unpayed'] = '订单 %s 的付款状态不是“未付款”';
$_LANG['ss_not_unshipped'] = '订单 %s 的成交状态不是“未成交”';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、看房方式、包装、贺卡、红包等）以主订单为准。';
...
$_LANG['order'] = '订单：';
$_LANG['confirm_order'] = '以下订单无法设置为联系状态';
...
$_LANG['select_shipping'] = '请先选择看房方式';
...
$_LANG['continue_shipping'] = '由于您修改了产权人所在地区，导致原来的看房方式不再可用，请重新选择看房方式';
$_LANG['continue_payment'] = '由于您修改了看房方式，导致原来的支付方式不再可用，请重新选择看房方式';
$_LANG['refund'] = '退款';
$_LANG['cannot_edit_order_shipped'] = '您不能修改已成交的订单';
$_LANG['address_list'] = '从已有收货地址中选择：';
$_LANG['order_amount_change'] = '订单总金额由 %s 变为 %s';
$_LANG['shipping_note'] = '说明：因为订单已成交，修改看房方式将不会改变看房费和保价费。';
...
$_LANG['return_order_gift_integral'] = '由于退货或未成交操作，退回订单 %s 赠送的积分';
$_LANG['invoice_no_mall'] = '&nbsp;&nbsp;&nbsp;&nbsp;多个成交单号，请用英文逗号（“,”）隔开。';

$_LANG['js_languages']['input_price'] = '自定义价格';
$_LANG['js_languages']['pls_search_user'] = '请搜索并选择会员';
$_LANG['js_languages']['confirm_drop'] = '联系要删除该房源吗？';
...
$_LANG['js_languages']['pls_select_shipping'] = '请选择看房方式';
...
/* 成交单操作 */
$_LANG['delivery_operate'] = '成交单操作：';
$_LANG['delivery_sn_number'] = '成交单流水号：';
$_LANG['invoice_no_sms'] = '请填写成交单号！';

/* 成交单搜索 */
$_LANG['delivery_sn'] = '成交单';

/* 成交单状态 */
$_LANG['delivery_status'][0] = '已成交';
$_LANG['delivery_status'][1] = '退货';
$_LANG['delivery_status'][2] = '正常';

/* 成交单标签 */
$_LANG['label_delivery_status'] = '成交单状态';
$_LANG['label_suppliers_name'] = '供货商';
$_LANG['label_delivery_time'] = '生成时间';
$_LANG['label_delivery_sn'] = '成交单流水号';
$_LANG['label_add_time'] = '下单时间';
$_LANG['label_update_time'] = '成交时间';
$_LANG['label_send_number'] = '成交数量';

/* 成交单提示 */
$_LANG['tips_delivery_del'] = '成交单删除成功！';
