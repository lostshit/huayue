...
$_LANG['lab_goods_sn'] = '房源编号：';
$_LANG['lab_goods_cat'] = '房源分类：';
$_LANG['lab_other_cat'] = '扩展分类：';
$_LANG['lab_goods_brand'] = '开发商品牌：';
...
$_LANG['lab_picture'] = '上传户型图片：';
$_LANG['lab_thumb'] = '上传户型缩略图：';
$_LANG['auto_thumb'] = '自动生成户型缩略图';
$_LANG['lab_keywords'] = '房源关键词：';
$_LANG['lab_goods_brief'] = '房源简单描述：';
$_LANG['lab_seller_note'] = '商家备注：';
$_LANG['lab_goods_type'] = '房源类型：';
$_LANG['lab_picture_url'] = '户型图片外部URL';
$_LANG['lab_thumb_url'] = '户型缩略图外部URL';

$_LANG['lab_goods_weight'] = '房源质量：';
$_LANG['unit_g'] = '克';
$_LANG['unit_kg'] = '千克';
...
$_LANG['invalid_goods_img'] = '图片格式不正确！';
$_LANG['invalid_goods_thumb'] = '缩略图格式不正确！';
$_LANG['invalid_img_url'] = '房源相册中第%s个图片格式不正确!';

$_LANG['goods_img_too_big'] = '图片文件太大了（最大值：%s），无法上传。';
$_LANG['goods_thumb_too_big'] = '缩略图文件太大了（最大值：%s），无法上传。';
